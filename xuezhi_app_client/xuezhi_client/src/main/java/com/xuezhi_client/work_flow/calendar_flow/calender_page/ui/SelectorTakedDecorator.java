...
public class SelectorTakedDecorator extends BaseSelectorDecorator
{
	private final Drawable m_drawable;
	private OnShouldDecorateListener m_onShouldDecorateListener = null;

	public SelectorTakedDecorator()
	{
		m_drawable = DGlobal.GetInstance().getAppContext().getResources().getDrawable(R.drawable.have_been_taken);
	}
