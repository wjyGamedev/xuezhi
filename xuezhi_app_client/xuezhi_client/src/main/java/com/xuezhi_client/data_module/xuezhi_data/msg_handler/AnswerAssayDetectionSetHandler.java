...
public class AnswerAssayDetectionSetHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		...
		//解析成功，发送event
		AnswerAssayDetectionSetEvent event = new AnswerAssayDetectionSetEvent();
		DBusinessMsgHandler.GetInstance().answerAssayDetectionSetAction(event);
		return;
	}
}
