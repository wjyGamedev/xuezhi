...
public class AnswerAddMedicalPromptHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		...
		//解析成功，发送event
		AnswerAddMedicalPromptEvent event = new AnswerAddMedicalPromptEvent();
		DBusinessMsgHandler.GetInstance().answerAddMedicalPromptAction(event);
		return;
	}
}
