...
public class AnswerAssayDetectionAddHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		...
		//解析成功，发送event
		AnswerAssayDetectionAddEvent event = new AnswerAssayDetectionAddEvent();
		DBusinessMsgHandler.GetInstance().answerAssayDetectionAddAction(event);
		return;
	}
}
