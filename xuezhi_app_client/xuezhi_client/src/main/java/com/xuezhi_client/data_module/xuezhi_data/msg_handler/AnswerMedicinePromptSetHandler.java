...
public class AnswerMedicinePromptSetHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		...
		//解析成功，发送event
		AnswerMedicinePromptSetEvent event = new AnswerMedicinePromptSetEvent();
		DBusinessMsgHandler.GetInstance().answerMedicinePromptSetAction(event);
		return;
	}
}
