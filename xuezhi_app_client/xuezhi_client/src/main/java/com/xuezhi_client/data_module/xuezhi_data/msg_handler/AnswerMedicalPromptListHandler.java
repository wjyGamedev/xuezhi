...
public class AnswerMedicalPromptListHandler extends IResponseListener
{
	...
	public void onResponse(JSONObject response)
	{
		try
		{
			DMedicalPromptList medicalPromptList = DBusinessData.GetInstance().getMedicalPromptList();
		...
		//解析成功，发送event
		DBusinessMsgHandler.GetInstance().answerMedicalPromptListAction();
		return;
	}
}
