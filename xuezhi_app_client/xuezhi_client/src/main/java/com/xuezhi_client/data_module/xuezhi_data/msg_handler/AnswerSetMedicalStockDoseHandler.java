 ...
 */
public class AnswerSetMedicalStockDoseHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		...
		//解析成功，发送event
		AnswerSetMedicalStockDoseEvent event = new AnswerSetMedicalStockDoseEvent();
		DBusinessMsgHandler.GetInstance().answerSetMedicalStockDoseAction(event);
		return;
	}
}
