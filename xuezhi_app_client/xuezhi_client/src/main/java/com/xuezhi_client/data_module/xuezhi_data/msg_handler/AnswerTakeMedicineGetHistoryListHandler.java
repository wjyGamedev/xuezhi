...
import com.xuezhi_client.data_module.xuezhi_data.data.DTakeMedicineList;
...
public class AnswerTakeMedicineGetHistoryListHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		...
		//解析成功，发送event
		DBusinessMsgHandler.GetInstance().answerTakeMedicineGetHistoryListAction();
		return;
	}
}
