 ...
 */
public class AnswerMedicineBoxDeleteHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		...
		//解析成功，发送event
		AnswerMedicineBoxDeleteEvent event = new AnswerMedicineBoxDeleteEvent();
		DBusinessMsgHandler.GetInstance().answerMedicineBoxDeleteAction(event);
		return;
	}
}
