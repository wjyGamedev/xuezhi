...
public class AnswerMedicalStockListHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		try
		{
			DMedicalStockList medicalStockList = DBusinessData.GetInstance().getMedicalStockList();
			medicalStockList.serialization(response);
		}
		...
		//解析成功，发送event
		DBusinessMsgHandler.GetInstance().answerMedicalStockListAction();
		return;
	}
}
