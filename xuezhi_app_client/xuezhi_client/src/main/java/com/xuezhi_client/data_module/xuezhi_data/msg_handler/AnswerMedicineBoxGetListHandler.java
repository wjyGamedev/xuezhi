...
public class AnswerMedicineBoxGetListHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		try
		{
			DMedicineBoxList medicineBoxList = DBusinessData.GetInstance().getMedicineBoxList();
			medicineBoxList.serialization(response);
		}
