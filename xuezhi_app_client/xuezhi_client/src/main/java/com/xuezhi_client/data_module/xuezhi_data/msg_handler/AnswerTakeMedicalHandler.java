...
public class AnswerTakeMedicalHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		...
		//解析成功，发送event
		AnswerTakeMedicalEvent event = new AnswerTakeMedicalEvent();
		DBusinessMsgHandler.GetInstance().answerTakeMedicalAction(event);
		return;
	}
}
