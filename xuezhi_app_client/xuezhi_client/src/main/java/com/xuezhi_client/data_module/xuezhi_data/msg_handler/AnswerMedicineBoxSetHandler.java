 ...
 */
public class AnswerMedicineBoxSetHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		...
		//解析成功，发送event
		AnswerMedicineBoxSetEvent event = new AnswerMedicineBoxSetEvent();
		DBusinessMsgHandler.GetInstance().answerMedicineBoxSetAction(event);
		return;
	}
}
