...
public class AnswerMedicinePromptDeleteHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		...
		//解析成功，发送event
		AnswerMedicinePromptDeleteEvent event = new AnswerMedicinePromptDeleteEvent();
		DBusinessMsgHandler.GetInstance().answerMedicinePromptDeleteAction(event);
		return;
	}
}
