...
public class AnswerAddMedicalStockHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		...
		//解析成功，发送event
		AnswerAddMedicalStockEvent event = new AnswerAddMedicalStockEvent();
		DBusinessMsgHandler.GetInstance().answerAddMedicalStockAction(event);
		return;
	}
}
