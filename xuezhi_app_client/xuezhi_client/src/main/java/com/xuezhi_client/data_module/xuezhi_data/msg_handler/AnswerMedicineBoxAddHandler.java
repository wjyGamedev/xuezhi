...
public class AnswerMedicineBoxAddHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		...
		//解析成功，发送event
		AnswerMedicineBoxAddEvent event = new AnswerMedicineBoxAddEvent();
		DBusinessMsgHandler.GetInstance().answerMedicineBoxAddAction(event);
		return;
	}
}
