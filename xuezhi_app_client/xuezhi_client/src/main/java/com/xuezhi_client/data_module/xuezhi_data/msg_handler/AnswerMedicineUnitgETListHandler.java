...
import com.xuezhi_client.data_module.xuezhi_data.data.DMedicineUnitList;

import org.json.JSONException;
import org.json.JSONObject;

public class AnswerMedicineUnitGetListHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		try
		{
			DMedicineUnitList medicalUnitList = DBusinessData.GetInstance().getMedicalUnitList();
