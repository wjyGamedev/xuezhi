...
public class AnswerAddAssayDetectionInfoHandler extends IResponseListener
{
	@Override
	public void onResponse(JSONObject response)
	{
		...
		//解析成功，发送event
		AnswerAddAssayDetectionInfoEvent event = new AnswerAddAssayDetectionInfoEvent();
		DBusinessMsgHandler.GetInstance().answerAddAssayDetectionInfoAction(event);
		return;
	}
}
