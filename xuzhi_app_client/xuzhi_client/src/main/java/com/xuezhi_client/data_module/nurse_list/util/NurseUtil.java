...
public class NurseUtil
{
	...
	private static final String JUNIOR_HIGH_SCHOOL_LEVEL_AND_BELOW = DGlobal.GetInstance().getAppContext().getString(R.string
																															 .junior_high_school_level_and_below);
	private static final String SENIOR_MIDDLE_SCHOOLE              = DGlobal.GetInstance().getAppContext().getString(R.string
																															 .senior_middle_schoole);
	...
	{
		if (iStarLevel < s_iMinStar || iStarLevel > s_iMaxStar)
		{
			//TODO:Log error
			return s_iMinStar;
		}
