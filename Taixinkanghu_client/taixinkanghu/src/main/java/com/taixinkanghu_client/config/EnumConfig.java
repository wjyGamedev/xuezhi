...
public class EnumConfig
{
	...
	public enum PatientState
	{
		...
		PATIENT_STATE_HALF_CARE_MYSELF(DGlobal.GetInstance().getAppContext().getResources().getString(R.string.content_half_care_myself),
									   2
		),
		PATIENT_STATE_CANNT_CARE_MYSELF(DGlobal.GetInstance().getAppContext().getResources().getString(R.string.content_not_care_myself),
										3
		);
