package com.taixinkanghu_client.work_flow.change_nurse_flow.nurse_order_pay_page.ui;
...
import com.taixinkanghu_client.work_flow.change_nurse_flow.nurse_order_pay_page.msg_handler.NurseOrderPayInChangeNurseMsgHandler;
 ...
 */
public class NurseOrderPayInChangeNurseActivity extends BaseActivity
{
	//widget
	...
	//logical
	private NurseOrderPayInChangeNurseMsgHandler m_nurseOrderPayInChangeNurseMsgHandler = new NurseOrderPayInChangeNurseMsgHandler(this);
	...
	public class ClickBottomCommon implements View.OnClickListener
	{
		...
		public void onClick(View v)
		{
			...
			m_nurseOrderPayInChangeNurseMsgHandler.requestNurseOrderCheckAction();
			return;
		}
	}
	...
	public class NurseInServiceDialog implements DialogInterface.OnClickListener
	{
		...
		{
			m_nurseOrderPayInChangeNurseMsgHandler.checkFailedAction();
		}
	}
	...
	public class HandleClickEventOnExitDialog implements DialogInterface.OnClickListener
	{
		...
		public void onClick(DialogInterface dialog, int which)
		{
			...
			{
				m_nurseOrderPayInChangeNurseMsgHandler.cancelPayAction();
			}
			//02. 取消,关闭弹出对话框。
	...
	public class HandleClickEventOnTipsCashDialog implements DialogInterface.OnClickListener
	{
		...
		public void onClick(DialogInterface dialog, int which)
		{
			m_nurseOrderPayInChangeNurseMsgHandler.paySuccessAction();
		}
	}
	...
	{
		m_nurseOrderPayInChangeNurseMsgHandler.updateContent();
		return;
	}
	...
	public boolean isSelectedValid()
	{
		...
		{
			TipsDialog.GetInstance().setMsg(getString(R.string.error_tips_cash_cannt_in_wait_pay), this);
			TipsDialog.GetInstance().show();
			return false;
		}
