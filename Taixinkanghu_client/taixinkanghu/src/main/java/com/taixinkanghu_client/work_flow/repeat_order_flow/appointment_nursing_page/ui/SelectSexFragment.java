...
public class SelectSexFragment extends Fragment
{
	...
	{
		m_repeatOrderApoitNursingMsgHandler.setGenderStatus(EnumConfig.GenderStatus.MALE);
		cancelAction();
		return;
	}
	...
	{
		m_repeatOrderApoitNursingMsgHandler.setGenderStatus(EnumConfig.GenderStatus.FEMALE);
		cancelAction();
		return;
	}
