package com.taixinkanghu_client.work_flow.repeat_order_flow.nurse_order_pay_page.ui;
...
import com.taixinkanghu_client.work_flow.repeat_order_flow.nurse_order_pay_page.msg_handler.NurseOrderPayInRepeatOrderMsgHandler;
 ...
 */
public class NurseOrderPayInRepeatOrderActivity extends BaseActivity
{
	//widget
	...
	//logical
	private NurseOrderPayInRepeatOrderMsgHandler m_nurseOrderPayInRepeatOrderMsgHandler = new NurseOrderPayInRepeatOrderMsgHandler(this);
	...
	public class ClickBottomCommon implements View.OnClickListener
	{
		...
		public void onClick(View v)
		{
			...
			m_nurseOrderPayInRepeatOrderMsgHandler.requestNurseOrderCheckAction();
			return;
		}
	}
	...
	public class HandleClickEventOnExitDialog implements DialogInterface.OnClickListener
	{
		...
		public void onClick(DialogInterface dialog, int which)
		{
			...
			{
				m_nurseOrderPayInRepeatOrderMsgHandler.cancelPayAction();
			}
			//02. 取消,关闭弹出对话框。
	...
	public class NurseInServiceDialog implements DialogInterface.OnClickListener
	{
		...
		public void onClick(DialogInterface dialog, int which)
		{
			m_nurseOrderPayInRepeatOrderMsgHandler.checkFailedAction();
		}
	}
	...
	public class HandleClickEventOnTipsCashDialog implements DialogInterface.OnClickListener
	{
		...
		public void onClick(DialogInterface dialog, int which)
		{
			m_nurseOrderPayInRepeatOrderMsgHandler.payEndAction();
		}
	}
	...
	{
		m_nurseOrderPayInRepeatOrderMsgHandler.updateContent();
		return;
	}
