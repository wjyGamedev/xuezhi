...
package com.taixinkanghu_client.work_flow.appiontment_nursing_flow.nurse_order_pay.msg_handler;
...
public class NurseOrderPayInNormalMsgHandler extends BaseAppiontmentNursingFlowUIMsgHandler
{
	...
	public void updateContent()
	{
		...
		String orderSerialNum = m_dAppiontmentNursingFlow.getOrderSerialNum();
		nurseOrderPayInNormalActivity.getOrderSerialNumTV().setText(orderSerialNum);

		int totalPrice = m_dAppiontmentNursingFlow.getTotalPrice();
	...
	public void requestNurseOrderCheckAction()
	{
		...
		int orderID = m_dAppiontmentNursingFlow.getOrderID();
