...
public class SelectWeightFragment extends Fragment
{
	...
	{
		m_repeatOrderApoitNursingMsgHandler.setWeightRage(EnumConfig.WeightRage.WEIGHT_0_35);
		cancelAction();
		return;
	}
	...
	{
		m_repeatOrderApoitNursingMsgHandler.setWeightRage(EnumConfig.WeightRage.WEIGHT_35_50);
		cancelAction();
		return;
	}
	...
	{
		m_repeatOrderApoitNursingMsgHandler.setWeightRage(EnumConfig.WeightRage.WEIGHT_50_80);
		cancelAction();
		return;
	}
	...
	{
		m_repeatOrderApoitNursingMsgHandler.setWeightRage(EnumConfig.WeightRage.WEIGHT_80_120);
		cancelAction();
		return;
	}
	...
	{
		m_repeatOrderApoitNursingMsgHandler.setWeightRage(EnumConfig.WeightRage.WEIGHT_MORE_THAN_120);
		cancelAction();
		return;
	}
