package com.taixinkanghu_client.work_flow.nurse_order_pay_more_flow.nurse_orde_pay_in_pay_more_page.ui;
...
import com.taixinkanghu_client.work_flow.nurse_order_pay_more_flow.nurse_orde_pay_in_pay_more_page.msg_handler
		.NurseOrderPayInPayMoreMsgHandler;
 ...
 */
public class NurseOrderPayInPayMoreActivity extends BaseActivity
{
	//widget
	...
	//logical
	private NurseOrderPayInPayMoreMsgHandler m_nurseOrderPayInPayMoreMsgHandler = new NurseOrderPayInPayMoreMsgHandler(this);
	...
	public class ClickBottomCommon implements View.OnClickListener
	{
		...
		public void onClick(View v)
		{
			...
			m_nurseOrderPayInPayMoreMsgHandler.requestNurseOrderAlipayAction();
			return;
		}
	}
	...
	public class NurseInServiceDialog implements DialogInterface.OnClickListener
	{
		...
		{
			m_nurseOrderPayInPayMoreMsgHandler.checkFailedAction();
		}
	}
	...
	public class HandleClickEventOnExitDialog implements DialogInterface.OnClickListener
	{
		...
		public void onClick(DialogInterface dialog, int which)
		{
			...
			{
				m_nurseOrderPayInPayMoreMsgHandler.cancelPayAction();
			}
			//02. 取消,关闭弹出对话框。
	...
	{
		m_nurseOrderPayInPayMoreMsgHandler.updateContent();
		return;
	}
	...
	public boolean isSelectedValid()
	{
		...
		{
			TipsDialog.GetInstance().setMsg(getString(R.string.error_tips_pay_more_aciton_no_cash), this);
			TipsDialog.GetInstance().show();
			return false;
		}
