...
public class SelectPatientStateFragment extends Fragment
{
	...
	{
		m_repeatOrderApoitNursingMsgHandler.setPatientState(EnumConfig.PatientState.PATIENT_STATE_CARE_MYSELF);
		cancelAction();
		return;
	}
	...
	{
		m_repeatOrderApoitNursingMsgHandler.setPatientState(EnumConfig.PatientState.PATIENT_STATE_HALF_CARE_MYSELF);
		cancelAction();
		return;
	}
	...
	{
		m_repeatOrderApoitNursingMsgHandler.setPatientState(EnumConfig.PatientState.PATIENT_STATE_CANNT_CARE_MYSELF);
		cancelAction();
		return;
	}
